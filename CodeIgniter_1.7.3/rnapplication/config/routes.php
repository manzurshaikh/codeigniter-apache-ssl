...
/****	controller_file/function_used/mainsegment, template or folder category used/table 2 view/category 2 view/type 2 view/detail 2 view	****/ 
...
$route['all_user'] 							= 'process_checking/get_all/user/all';
$route['all_admin']							= 'process_checking/get_all/admin/all';